...
import {currencies, CurrencyRates, currencyUSDRates} from "../exercise/data";
...
const CurrencyConverter: React.FC<Props> = props => {
    ...
    return <div>
        <div>
            ...
            <CurrencySelect currencies={currencies} value={currencyConversion.fromCurrency} onChange={currency => setCurrencyConversion({...currencyConversion, fromCurrency: currency})}/>
        </div>

        <div>
            <input disabled value={convertedValue} onChange={e => setValue(e.target.value as any)}/>
            <CurrencySelect currencies={currencies} value={currencyConversion.toCurrency} onChange={currency => setCurrencyConversion({...currencyConversion, toCurrency: currency})}/>
        </div>
